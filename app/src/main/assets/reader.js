(function () {
  ...
  function processChapterFiles(fileObjs, folderName) {
    ...
    chaptersFolderStatus.textContent = 'Connected: ' + folderName;
  ...
  function pickChaptersFolder() {
    if (window.AndroidBridge && window.AndroidBridge.pickFolder) {
      ...
      alert('Folder access is not available. This app needs to run as the Android app, not a plain browser tab.');
    }
  }
